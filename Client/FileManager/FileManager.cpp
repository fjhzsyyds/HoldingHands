...
CFileManager::CFileManager(CIOCPClient*pClient) :
CMsgHandler(pClient, FILE_MANAGER)
{
	//init buffer.
...
static void BeginFileTrans(char* szServerAddr, unsigned short uPort, LPVOID lpParam)
{
	...
	CMsgHandler *pHandler = new CFileTrans(pClient, (CFileTrans::CMiniFileTransInit*)lpParam);
...
static  void BeginDownload(char* szServerAddr, unsigned short uPort, LPVOID lpParam)
{
	...
	CMsgHandler *pHandler = new CFileDownloader(pClient,(CFileDownloader::InitParam*)lpParam);
...
static void BeginSearch(char* szServerAddr, unsigned short uPort, LPVOID lpParam)
{
	...
	CMsgHandler *pHandler = new CFileMgrSearch(pClient);
